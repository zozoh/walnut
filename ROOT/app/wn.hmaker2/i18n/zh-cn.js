define({
    "hmaker" : {
        ...
        "site" : {
            ...
            "login_entry"     : "默认登录跳转",
            "login_entry_tip" : "当用户登录后，默认跳转的页面。如果不设置，则采用`默认入口页`。当然，如果其他页面自动跳转到登录页面，通常登录成功后，会返回对应的页面的。",
        ...
        "com" : {
            ...
            "dynamic" : {
                ...
                "behavior" : "控件行为",
                "tip_nodata" : "空数据提示",
                "tip_nodata_tip" : "当接口加载数据为空时，显示给用户的提示",
                "need_cnd"     : "需要条件",
                "need_cnd_tip" : "如果查询条件为空，则不读取数据",
                "tip_need_cnd"     : "条件提示",
                "tip_need_cnd_tip" : "当查询条件为空，显示给用户的提示",
