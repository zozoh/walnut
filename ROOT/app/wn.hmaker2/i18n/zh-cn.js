    ...
    "hmaker" : {
        ...
        "com" : {
            ...
            "filter" : {
                ...
                "ext_show" : "展开",
                "ext_hide" : "收起",
                "fld_name_tip" : "字段名即参数名，主要是看你要访问的数据接口能接受什么样的参数，如果你实在搞不清要写什么，请联系你的数据接口提供者，他/她应该会告诉你一切",
                "fld_text_tip" : "本字段显示给用户看的文字，起的帅一点哦 ^_^",
                "fld_multi" : "可多选",
                "fld_hide"  : "折叠",
                ...
                "fld_item_edit" : "编辑选项",
                "fld_item_del" : "删除选项",
                "fld_item_mv_prev" : "前移选项",
                "fld_item_mv_next" : "后移选项",
                "fld_item_text" : "选项描述",
