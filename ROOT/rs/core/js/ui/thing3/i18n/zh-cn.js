    ...
    "th3" : {
        ...
        "conf" : {
            ...
            "cicon" : {
                ...
                "array"        : '<i class="zmdi zmdi-format-list-numbered"></i>',
                "file"         : '<i class="zmdi zmdi-collection-text"></i>',
                "icon"         : '<i class="zmdi zmdi-cocktail"></i>',
                "image"        : '<i class="zmdi zmdi-image-o"></i>',
                "list"         : '<i class="zmdi zmdi-format-list-bulleted"></i>',
                "name"         : '<i class="zmdi zmdi-cast"></i>',
                "date"         : '<i class="zmdi zmdi-calendar-note"></i>',
                "time"         : '<i class="zmdi zmdi-time"></i>',
                "datetime"     : '<i class="zmdi zmdi-time-restore"></i>'
            },
            "blank"          : "请选择一个字段进行设置",
            "saveflds"       : "保存字段修改",
            "saving"         : "正在保存字段设置 ... ",
