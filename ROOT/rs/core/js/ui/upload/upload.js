...
//===================================================================
    var ZUI = require("zui");
    var ZHTTP = require("nutz/zhttp.js");
    module.exports = ZUI.def("ui.upload", {
        ...
        init: function (options) {
            ...
            // 读取上传配置
            var uploadConfStr = Wn.exec("cat .uploadconf").trim();
            if (uploadConfStr[0] == '{' && uploadConfStr[uploadConfStr.length - 1] == "}") {
                UI.uploadOption = eval('(' + uploadConfStr + ')');
                UI.uploadCompass = UI.uploadOption.disable != true;
            } else {
                UI.uploadOption = {disable: true};
                UI.uploadCompass = false;
            }
            console.log("uploadCompass:" + UI.uploadCompass)
            console.log("uploadOption:" + JSON.stringify(UI.uploadOption))
        },
        //...............................................................
        events: {
