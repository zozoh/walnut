...
//==============================================
        var html = `
<div class="ui-arena obrowser-chute-sidebar" mode="mini" ui-fitparent="yes">
</div>`;
//==============================================
        return ZUI.def("ui.obrowser_chute_sidebar", {
            ...
            __format_sideHTML: function (jq) {
                ...
                jq.find("item").each(function () {
                    var jItem = $(this);
                    var jWrap = jItem.children('p');
                    var jIcon = jWrap.children("i");
                    var jText = jWrap.children("a");
