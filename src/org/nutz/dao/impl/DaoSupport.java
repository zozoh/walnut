...
public class DaoSupport implements Configurable {
    ...
    public DaoSupport() {
        ...
        this.setInterceptors(Wlang.list((Object) "log"));
    }
        ...
        run(new ConnCallback() {
            public void invoke(Connection conn) throws Exception {
                try {
                    ...
                    if (dmd.getDriverName().contains("mariadb")
                        || dmd.getDriverName().contains("sqlite")) {
    ...
    protected DaoInterceptor _makeInterceptor(Object it) {
        ...
        if (it instanceof String) {
            ...
            if ("log".equals(itName)) {
                ...
                Class<?> klass = Wlang.loadClassQuietly(itName);
                if (klass == null) {
