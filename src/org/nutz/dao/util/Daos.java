...
public abstract class Daos {
    ...
    public static int getColumnIndex(ResultSetMetaData meta, String colName) throws SQLException {
        ...
        throw Wlang.makeThrow(SQLException.class, "Can not find @Column(%s)", colName);
    }
    ...
    public static void insertBySpecialChain(Dao dao, Entity en, String tableName, Chain chain) {
        ...
        if (tableName == null) {
            throw Wlang.makeThrow(DaoException.class, "tableName and en is NULL !!");
        }
    ...
    public static void migration(Dao dao,
        ...
        if (checkIndex) {
            ...
            if (!Wlang.isEmptyArray(delIndexSqls)) {
        ...
        if (checkIndex) {
            ...
            if (!Wlang.isEmptyArray(addIndexSqls)) {
    ...
    private static UpdateIndexSql createIndexs(Dao dao,
        ...
        while (iterator.hasNext()) {
            ...
            if (delIndexs.contains(indexName) || Wlang.isEqual("PRIMARY", indexName)) {
                continue;
            }
