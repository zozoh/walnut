...
public class ZMo {
    ...
    public ZMoDoc toDoc(Object obj) {
        ...
        // 本身就是 Document
            ...
            return ZMoDoc.WRAP((Document) obj);
        }
        // 普通 Map
     ...
     * @return 普通Java对象
     */
    public Object fromDoc(ZMoDoc dbobj, ZMoEntity en) {
        if (null == dbobj)
            return null;
        ...
        for (String key : keys) {
            try {
                ...
                String msg = String.format("fail to set field %s#%s", en.getType(), key);
    ...
    public <T> T fromDocToObj(ZMoDoc dbobj, Class<T> classOfT) {
     ...
     */
    @SuppressWarnings("unchecked")
    public Map<String, Object> fromDocToMap(ZMoDoc dbobj) {
     ...
     */
    @SuppressWarnings("unchecked")
    public <T extends Map<String, Object>> T fromDocToMap(ZMoDoc dbobj, Class<T> classOfMap) {
    ...
    public List<Object> fromDoc(Iterable<Document> it, ZMoEntity en) {
        List<Object> list = new LinkedList<Object>();
        it.forEach(row -> {
            ZMoDoc doc = ZMoDoc.WRAP(row);
            Object obj = fromDoc(doc, en);
            list.add(obj);
        });
        return list;
    }
