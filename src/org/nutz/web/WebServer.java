...
public class WebServer {
    ...
    protected void prepare() throws IOException {
        ...
        if (warUrlString.endsWith(".war") || dc.has("war")) {
            ...
            wac.setServerClasses(new String[]{"org.objectweb.asm.", // hide asm
                                                                    // used by
                                                                    // jetty
                                              "org.eclipse.jdt.", // hide jdt
                                                                  // used by
                                                                  // jetty
            ...
            if (ins != null) {
                ...
                wac.addFilter(new FilterHolder(new WebAllowFilter(allowPaths)),
                              "/*",
