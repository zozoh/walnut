package org.nutz.walnut.ext.geo.lbs;
...
import org.nutz.walnut.ext.geo.lbs.bean.LbsCountry;
...
public class cmd_lbs extends JvmHdlExecutor {
    ...
    static {
        String str = Files.read("org/nutz/walnut/ext/geo/lbs/data/countries.json");
