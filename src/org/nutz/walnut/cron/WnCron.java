...
public class WnCron {
     ...
     * @return 自身以便链式使用
     */
    public WnCron parse(String cron) {
        this.str = cron;
    ...
    public WnCron setPartExtTime(String str) {
        return this.__set_part(0, str);
    }

    public WnCron setPartStdTime(String str) {
        return this.__set_part(1, str);
    }

    public WnCron setPartStdDate(String str) {
        return this.__set_part(2, str);
    }

    public WnCron setPartExtDate(String str) {
        return this.__set_part(3, str);
    }

    WnCron __set_part(int index, String str) {
     ...
     * @return 人类可以读懂的字符串
     */
    public String toText(WnCroni18n i18n) {
    ...
    private void __join_date_region(WnCroni18n i18n, List<String> ary) {
