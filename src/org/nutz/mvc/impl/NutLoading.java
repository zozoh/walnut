...
public class NutLoading implements Loading {
    ...
    public UrlMapping load(NutConfig config) {
        ...
        if (log.isDebugEnabled()) {
            ...
            log.debugf(" - context.tempdir : %s",
                       config.getAttribute("javax.servlet.context.tempdir"));
    ...
    protected UrlMapping evalUrlMapping(NutConfig config, Class<?> mainModule, Ioc ioc)
        ...
        EntryDeterminer determiner = null == ann ? new NutEntryDeterminer()
                                                 : Loadings.evalObj(config,
                                                                    ann.value(),
                                                                    ann.args());
    ...
    protected Set<Class<?>> getModuleClasses(Ioc ioc,
                                             Class<?> mainModule,
                                             EntryDeterminer determiner) {
