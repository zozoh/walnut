...
public abstract class AbstractAdaptor implements HttpAdaptor2 {
    ...
    public void init(Method method) {
        init(method, Wlang.collection2array(MethodParamNamesScaner.getParamNames(method), String.class));
    }
                ...
                for (int i = 0; i < args.length - 1; i++) {
                	if (args[i] == null) {
                    	if (defaultValues[i] != null) {
                    		...
                    		args[i] = Wlang.getPrimitiveDefaultValue(argTypes[i]);
                    	}
                    }
				}
