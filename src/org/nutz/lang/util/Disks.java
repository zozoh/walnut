...
public abstract class Disks {
    ...
    public static String getRelativePath(String base, String path, String equalPath) {
        ...
        sb.append(Wlang.concat(pos, ff.length - pos, '/', ff));
        if (path.endsWith("/"))
            sb.append('/');
        return sb.toString();
    }
    ...
    public static String getIntersectPath(String ph0, String ph1, String dft) {
        ...
        // 得到
        String re = Wlang.concat(0, pos, "/", ss0).toString();
    ...
    public static String getCanonicalPath(String path) {
        ...
        StringBuilder sb = new StringBuilder(Wlang.concat("/", paths));
        if (path.startsWith("/"))
            sb.insert(0, '/');
        if (path.endsWith("/"))
            sb.append('/');
    ...
    public static String appendPath(String... phs) {
        ...
        if (null != paths && paths.length > 0) {
            ...
            // if (null == paths[0])
            // paths[0] = "/";
            String str = Wlang.concat("/", paths).toString();
            String[] ss = Strings.splitIgnoreBlank(str, "/");
            str = Wlang.concat("/", ss).toString();
