...
public class WnSeqHHIdGenerator implements WnIdGenerator {

    private String prefix;
    private SeqGenerator seq;
    private int n;

    public WnSeqHHIdGenerator(String prefix, SeqGenerator seq, int n) {
        this.prefix = prefix;
        this.seq = seq;
        this.n = n;
    }

    public WnSeqHHIdGenerator(String prefix, SeqGenerator seq) {
        this(prefix, seq, 5);
    }
