...
public class aliyuniot_cron2 extends aliyuniot_pub {
    ...
    public void invoke(WnSystem sys, JvmHdlContext hc) throws Exception {
        ...
        // 看来合法了
        hc.params.setv("msg", Json.toJson(new NutMap("method", "setv").setv("data", new NutMap("Cron", cron).setv("OpMode", "cron"))));
        super.invoke(sys, hc);
    }
