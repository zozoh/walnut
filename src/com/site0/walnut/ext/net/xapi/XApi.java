...
public interface XApi {
    ...
    XApiConfigManager getConfigManager();

    XApiExpertManager getExpertManager();
    ...
    NutBean loadConfig(String apiName, String account);
     ...
     * @return 第三方接口请求对象
     */
    XApiRequest prepare(String apiName, String account, String path, NutBean vars, boolean force);
     ...
     */
    <T> T send(XApiRequest req, Class<T> classOfT) throws XApiException;
}
