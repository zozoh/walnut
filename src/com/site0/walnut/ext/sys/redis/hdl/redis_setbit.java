...
public class redis_setbit extends RedisFilter {
    @Override
    protected void process(WnSystem sys, RedisContext fc, ZParams params) {
        ...
        int value = params.val_check_int(2);
        fc.addHandler(new RedisHanlder("SETBIT", key) {
            public Object run(RedisContext fc, Jedis jed) {
                return jed.setbit(key, offset, value == 1);
            }
        });
    }
}