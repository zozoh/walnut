package com.site0.walnut.ext.data.titanium.impl;
...
import com.site0.walnut.ext.data.titanium.util.TiViewMapping;
import com.site0.walnut.util.Wn;
import com.site0.walnut.util.WnObjDataCachedFactory;

@IocBean(create = "on_create")
public abstract class TiRouteingService<T> {
    ...
    public TiRouteingService(Class<T> defType, String dirName) {
