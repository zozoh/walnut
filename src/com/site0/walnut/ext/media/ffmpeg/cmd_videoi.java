...
public class cmd_videoi extends JvmExecutor {
    ...
    public void exec(WnSystem sys, String[] args) throws Exception {
        ...
        if (obj.hasMime() && obj.mime().startsWith("video/")) {
            ...
            if (vi != null) {
                ...
                // sys.err.printf("read %s(%s) videoInfo has err", obj.name(),
                // obj.id());
                throw Err.create("e.cmds.videoi.video_info_null");
            }
        } else {
            throw Err.create("e.cmds.videoi.not_video",
                             String.format("obj %s(%s) is not a video", obj.name(), obj.id()));
        }
    }
