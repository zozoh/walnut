package com.site0.walnut.ext.util.crc.hdl;
...
@JvmHdlParamArgs("^(hex)$")
public class crc_modbus16 implements JvmHdl {
	...
	public void invoke(WnSystem sys, JvmHdlContext hc) throws Exception {
		...
		if (sys.pipeId > 0) {
			...
			WnObj wobj = sys.io.check(null, Wn.normalizeFullPath(hc.params.getString("f"), sys));
			ins = sys.io.getInputStream(wobj, 0);
		}
		else if (hc.params.vals.length > 0) {
			ins = new ByteArrayInputStream(hc.params.vals[0].getBytes());
		}
		else {
...
//		CRC16M crc16 = new CRC16M();
//		crc16.update("ABC".getBytes(), 3);
////		System.out.println(CRC16M.getBufHexStr("ABC".getBytes()));
//		System.out.printf("%02X%02X", crc16.uchCRCLo, crc16.uchCRCHi);
//	}
}
