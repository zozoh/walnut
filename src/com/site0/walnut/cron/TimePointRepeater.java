...
class TimePointRepeater {
    ...
    private static String _T(WnCroni18n i18n, String key, Object value) {
        return i18n.times.get(key).replace("?", value.toString());
    }

    public void joinText(WnCroni18n i18n, List<String> ary) {
        // 时间点
        if (null != timePoints) {
    ...
    private void __join_time_points(WnCroni18n i18n, List<String> ary) {
    ...
    private void __join_step_info(WnCroni18n i18n, List<String> ary) {
        String re = "";
        // 得到步长描述
    ...
    private void __join_time_region(WnCroni18n i18n, List<String> ary) {
        if (null == this.region)
            return;
