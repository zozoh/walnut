...
class CrnStdItem implements CrnItem {
    ...
    private String _T(WnCroni18n.Item lc, WnCroni18n i18n, int n) {
        // 特殊的周 FRI#3
    ...
    @Override
    public void joinText(List<String> ary, WnCroni18n i18n, String key) {
    ...
    public int joinText(List<String> ary,
        ...
        if (off >= this.values.length)
            return -1;
        WnCroni18n.Item lc = i18n.getItem(key);
