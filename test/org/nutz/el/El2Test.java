...
public class El2Test {
    ...
    public void context() {
        ...
        assertTrue((Boolean) El.eval(Wlang.context(), "a==null"));
        try {
            assertTrue((Boolean) El.eval(Wlang.context(), "a.a"));
            fail();
        }
        catch (Exception e) {}
    }
    ...
    public void map() {
        Context context = Wlang.context();
        context.set("a", Wlang.map("{x:10,y:50,txt:'Hello'}"));
    ...
    public void test_map_get() {
        ...
        List<String> list = new ArrayList<String>();
        list.add("abc");
        assertEquals("http://wendal.net", El.eval(Wlang.context().set("ctx", map), "ctx['wendal']"));
        assertEquals("abc", El.eval(Wlang.context().set("list", list), "list[0]"));
    }
