...
public class FastClassFactoryTest extends Assert {
    ...
    public void testInvokeObjectMethodObjectArray() throws Throwable {
        ...
        // net.sf.cglib.reflect.FastClass fc2 =
        // net.sf.cglib.reflect.FastClass.create(Pet.class);
        ...
        // for (int i = 0; i < 10000; i++) {
        // fc2.getDeclaredConstructor().newInstance();
        // }
        System.gc();
        ...
        // sw = Stopwatch.begin();
        // for (int i = 0; i < 1000000; i++) {
        // pet = (Pet) fc2.newInstance(new Class[]{String.class}, new
        // Object[]{"wendal"});
        // }
        //
        // sw.stop();
    ...
    public static void main(String[] args) throws Exception {
        // ASMifier.main(new
        // String[]{"target/classes/org/nutz/lang/reflect/SimpleFastClass.class"});
    }
}
