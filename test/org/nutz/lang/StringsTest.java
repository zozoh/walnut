...
public class StringsTest {
    ...
    public void test_replaceBy() {
        assertEquals("xB-", Strings.replaceBy("ABC", Wlang.map("{A:'x',C:'-'}")));
        assertEquals("AB-x", Strings.replaceBy("ABCA", Wlang.map("{A:'x',C:'-',AB:null}")));
        assertEquals("AB-AD-x",
                     Strings.replaceBy("ABCADCA", Wlang.map("{A:'x',C:'-',D:'$','A[BD]':null}")));
    }
