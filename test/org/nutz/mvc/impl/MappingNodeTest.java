...
public class MappingNodeTest {
    ...
    public void test_remain() {
        ...
        assertEquals("b,c", Wlang.concat(",", ac.getPathArgs()).toString());
        ...
        assertEquals("", Wlang.concat(",", ac.getPathArgs()).toString());
    ...
    public void test_quesmark_asterisk() {
        ...
        assertEquals("B", root.get(ac, "/a/c/d/e"));
        assertEquals("/a/c/d/e", ac.getPath());
        assertEquals("c,d,e", Wlang.concat(",", ac.getPathArgs()).toString());
        ...
        assertEquals("a,o,p", Wlang.concat(",", ac.getPathArgs()).toString());

        assertEquals("D", root.get(ac, "/x/a"));
        assertEquals("/x/a", ac.getPath());
        assertEquals("a", Wlang.concat(",", ac.getPathArgs()).toString());
