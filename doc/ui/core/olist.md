...
new UIOList({
    ...
    */
    ...
    当然，你可以结合 icon 段来使用，相当于给 icon 的 HTML 添加一个 class
    如果你没声明 icon 段，那么默认的 HTML 相当于 "<i>"
    ...
    */
    ...
    // 如果通过 text 段定制你觉得太复杂，可以用这个函数来定制一个对象的显示
    // 当然，如果你声明了 text 段，这个段的返回值将会修改 text 段生成 HTML
    // 的文本内容，就是说，如果你生成了复杂的结构文本节点，你需要指定 selector
    // 来说明你要修改那个节点的文本
    display : {
        key : "nm",
        map : {
        ...
        dft : null,
        selector : null,   // 你要修改 text 段生成 HTML 的哪个子节点，不写，
                           // 直接改顶级节点的 text
    }
