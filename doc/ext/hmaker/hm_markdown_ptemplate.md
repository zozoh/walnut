...
-group
  ...
  +text.bold:简单快速地清洗
  +text:升级核心组件，不再残留果渣，清水就可以简单完成冲洗。 没有刀片的结构，清洗更加安全
-group
  +picture:media/12-b.jpg
  +text.bold:一步到位完成组装
  +text:简单明了的组装引导槽，让所有部件的安装一目了然
```
...
-group
    -group
      +picture:media/14-a.jpg
      +text.bold:独特7°倾斜前体
      +text:果汁不再残留，品尝每一滴自然美味！
    -group
      +picture:media/14-b.jpg
      +text.bold:更方便的调节阀
      +text:调节阀可以调整前体内的压力，更好地适应不同硬度的食材；推高调节阀，还可让前体更加容易清洗。
    -group
      +picture:media/14-c.jpg
      +text.bold:升级型双投料口
      +text:投料口加宽，倾斜度更佳，轻松投入不同食材。
    -group
      +picture:media/14-d.jpg
      +text.bold:追求细节的设计
      +text:我们改进了果汁托盘、操作转盘等细节的设计
      +text:只为不断追求更好的使用体验
```
...
-group
    -group
      ...
      -group.it-title
          +text.big:纯果汁组件
          +picture:media/20-a-s.jpg
      +text:过滤掉更多阻碍吸收的固体物质，果汁口感更加纯粹顺滑
-group
    -group
      +picture:media/20-b.jpg
      -group.it-title
          +text.big:果粒果汁组件
          +picture:media/20-b-s.jpg
      +text:过滤间隙更宽，保留部分果粒和固体纤维，更适合压榨软性的草莓、香蕉、猕猴桃等水果
-group
    -group
      +picture:media/20-c.jpg
      -group.it-title
          +text.big:冰淇淋组件
          +picture:media/20-c-s.jpg
      +text:更换冰淇淋组件后，关闭出汁口，放入冷冻的水果如芒果、草莓等，直接制作水果冰淇淋，还可加入牛奶或酸奶
+text.tip:*请参阅说明书及食谱了解详细使用方法
```
...
@bgcolor:#444
+text.big:超凡魅力，低调优雅
+text:精致高雅的气息结合现代设计感，追求品味的惠人原汁榨汁机不仅仅是一台电器，更是您对生活品质的一份声明
-group
...
+text.big:惠人固执的坚持，不变的初心
+text:我们始终将健康视为重中之重，
+text:根据用户体验，不断研究和实践。
-group
  +picture:media/30-a.jpg
  +text.bold:惠人生物食品研究所
  +text:为了改善现代人的饮食习惯，帮助人们维持健康的生活，惠人对水果和蔬菜进行了功效测试，制定了食谱，并坚持进行各种果汁和健康的研究。
-group
  +picture:media/30-b.jpg
  +text.bold:惠人产品实验室
  +text:坚持不懈地从事产品研究工作。 我们利用专利原创技术制造健康果汁，并不断研发创新，评估和改进我们的产品。
```
